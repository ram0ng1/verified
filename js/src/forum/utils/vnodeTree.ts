 ...
 */
export function findVnodeByClass(node: unknown, className: string): VnodeLike | null {
 ...
 */
export function makeVerifiedVnode(user: User | null | undefined, className: string): Mithril.Vnode | null {
