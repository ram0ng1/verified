    ...
    return (
      <div className="VerifiedAdmin-row">
        ...
        <input
          ...
          step="0.05"
          value={clamped}
          oninput={(e: Event) => this.settingsState.queueSize((e.target as HTMLInputElement).value)}
        />
    ...
    return (
      <div className="Form-group VerifiedAdmin-row">
        ...
        <select
          ...
          value={mode}
          onchange={(e: Event) => this.settingsState.setRetentionMode((e.target as HTMLSelectElement).value)}
        >
        ...
        {mode === 'delete_after_days' && (
          <div className="VerifiedAdmin-subGroup VerifiedAdmin-retentionDays">
            ...
            <input
              ...
              step="1"
              value={days}
              oninput={(e: Event) => this.settingsState.queueRetentionDays((e.target as HTMLInputElement).value)}
            />
